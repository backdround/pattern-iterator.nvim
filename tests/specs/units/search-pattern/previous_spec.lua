...
describe("search-pattern.next", function()
  ...
  it("there is no next pattern", function()
    ...
    local pattern_position = search_pattern.previous("\\M<a>", from_position)
  ...
  describe("simple pattern", function()
    ...
    it("from a position that is after a pattern", function()
      local from_position = position.from_coordinates(1, 7)
      local pattern_position = search_pattern.previous(pattern, from_position)
  ...
  describe("muliline pattern", function()
    ...
    describe("pattern == '$'", function()
      ...
      it("from a position that is at the pattern", function()
        ...
        assert.pattern_position(pattern_position, { 1, 4 }, { 1, 4 })
      end)
    end)
    ...
    describe("pattern == '^'", function()
      ...
      it("from a position that is on the pattern", function()
        ...
        assert.pattern_position(pattern_position, { 1, 0 }, { 1, 0 })
      end)
    end)
